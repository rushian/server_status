							...
							<tr>
								...
								<td> <?php $user =  DB::table('users')->where('id','=',$serve->id_usuario)->get() ;?>
								 ...
								 <td>
									...
									{{ method_field('PATCH') }}
							 		<input class="input-small" type="hidden" name="id_usuario" value="{{ Auth::user()->id }}">
							 		<input class="input-small" type="hidden" name="updated_at" value="{{ date("Y-m-d H:i:s") }}">
							 		<input class="input-small" type="hidden" name="_token" value="{{ csrf_token() }}">
